...
namespace BkApiTeste.Controllers
{
    ...
    public class FornecedorsController : ControllerBase
    {
        ...
        [HttpGet("ByName")]
        public async Task<IQueryable<Fornecedor>> GetFornecedorByName(string name)
        {
            
            var fornecedor = _context.Fornecedor.Where(p => p.Nome == name);
        ...
        [HttpGet("ByCnpj")]
        public async Task<IQueryable<Fornecedor>> GetFornecedorByCnpj(string cnpj)
        {

            var fornecedor = _context.Fornecedor.Where(p => p.Nome == cnpj);
